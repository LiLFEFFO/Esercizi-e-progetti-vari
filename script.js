...
function indovinaNumero() {
    ...
    if (numeroUtente == numerodaIndovinare) {
        ...
        document.getElementById("risultato").innerText = numeroUtente + " è troppo basso, riprova"
    }
    else {
        document.getElementById("risultato").innerText = numeroUtente + " è troppo alto, riprova"
    }
}
